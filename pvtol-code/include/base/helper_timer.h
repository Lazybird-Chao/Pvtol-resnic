...
/*
 *   sdkTimer
 *   bool sdkCreateTimer(sdkTimer **)
 *   bool sdkStartTimer(sdkTimer **)
 *   bool sdkStopTimer(sdkTimer**)
 *   bool sdkResetTimer(sdkTimer**)
 *   bool sdkDeleteTimer(sdkTimer**)
 *   float sdkGetTimerValue(sdkTimer**)
 */
...
typedef  StopWatchInterface	sdkTimer;
